/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bf70755f5b9eb65bf25ebcf06d8f0c73)
// Runtime types generated with workerd@1.20260915.1 2026-09-15 nodejs_compat
interface __BaseEnv_Env {
	KV: KVNamespace;
	DB: D1Database;
	RL_AUTH: RateLimit;
	RL_CHECKOUT: RateLimit;
	RL_API: RateLimit;
	ASSETS: Fetcher;
	APP_ENV: "staging" | "production" | "development";
	APP_URL: "https://fdm-preview.follies.workers.dev" | "https://fdm-staging.follies.workers.dev" | "https://fdm.follies.workers.dev" | "http://localhost:5173";
	ALLOWED_ORIGINS: "https://fdm-preview.follies.workers.dev" | "https://fdm-staging.follies.workers.dev" | "https://fdm.follies.workers.dev" | "http://localhost:5173,http://localhost:8787";
	EMAIL_FROM: "Follies d'Après-Midi <folliesdapresmidi@gmail.com>" | "Follies d'Après-Midi <orders@example.com>" | "Follies d'Après-Midi <onboarding@resend.dev>";
	PASSWORD_ITERATIONS: "10000" | "100000";
...
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		EMAIL_FROM: "Follies d'Après-Midi <folliesdapresmidi@gmail.com>";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_URL" | "ALLOWED_ORIGINS" | "EMAIL_FROM" | "PASSWORD_ITERATIONS" | "PASSWORD_PEPPER" | "COOKIE_SECRET" | "SETUP_TOKEN" | "RESEND_API_KEY">> {}
}
